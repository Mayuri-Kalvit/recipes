...
export default function RecipeForm({ recipe }: RecipeFormProps) {
    ...
    return (
        <form action={formAction} className="space-y-16 max-w-3xl mx-auto py-12">
            ...
            <input type="hidden" name="author_note" value={recipe?.author_note || ''} />
                        ...
                        {imagePreview ? (
                            <div className="absolute inset-0 z-10">
                                ...
                                <button
                                    ...
                                    className="absolute top-4 right-4 p-2 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md rounded-full shadow-sm hover:scale-110 transition-transform z-30"
                                >
                                    <X size={16} />
                                </button>
                            </div>
